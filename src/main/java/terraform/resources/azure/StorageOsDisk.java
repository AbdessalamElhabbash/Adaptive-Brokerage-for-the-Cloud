...
public class StorageOsDisk {
	private String name; //Required;
	private String caching; //Possible values include None, ReadOnly and ReadWrite.
	private String create_option; //Required. Possible values are Attach, FromImage.
	private String disk_size_gb;
	private String image_uri; 
	private String os_type; //Possible values are Linux and Windows.
	...
	public static final Set<String> OS_TYPES;
	...
	/**
	 * @return the image_uri
	 */
	public String getImage_uri() {
		return image_uri;
	}
	/**
	 * @param image_uri the image_uri to set
	 */
	 ...
	 * @param create_option the create_option to set
	 */
	public void setOs_type(String os_type) throws InvalidTypeException{
		if(OS_TYPES.contains(os_type)){
			this.os_type = os_type;
		}else{
			throw new InvalidTypeException("Possible values are Linux and Windows.");
		}
	}
	/**
	...
	private boolean isValid() throws RequiredArgumentException{
		if(name == null || name.equals("")){
			throw new RequiredArgumentException("name conifig is required for the storage_os_disk object");		
		}
		if(caching == null || caching.equals("")){
			throw new RequiredArgumentException("caching conifig is required for the storage_os_disk object");		
		}		
		if(managed_disk_id != null && !managed_disk_id.equals("") && !create_option.equals("\"Attach\"")){
			throw new RequiredArgumentException("managed_disk_id conifig is required for the storage_os_disk object");		
		}
		if(write_accelerator_enabled && !managed_disk_type.equals("\"Premium_LRS\"") && !caching.equals("\"None\"")){
			throw new RequiredArgumentException("write_accelerator_enabled conifig is required for the storage_os_disk object");		
		}		
		return true;
	}
	...
	public String getBlock(int level) {
		...
		String block = headIndent + "storage_os_disk { \n" ;
		...
		if(image_uri != null && !image_uri.equals("")){
			block += elementIndent + "lun = \"" + image_uri + "\"\n";
		}
